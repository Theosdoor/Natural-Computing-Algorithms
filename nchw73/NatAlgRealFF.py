...
num_cyc = 10000
N = 100 # num fireflies
lambbda = 0.1 # light absorption coefficient
...
def firefly_search(N, num_cyc, lambbda, alpha):
    # generate random fireflies
    fireflies = numpy.random.uniform(min_range, max_range, (N, n))
    fitnesses = numpy.array([fitness(firefly) for firefly in fireflies])
